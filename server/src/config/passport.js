...
module.exports = function(passport) {
  // Google OAuth é opcional - só configura se as credenciais estiverem presentes
  if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    ...
    logger.warn('Google OAuth desabilitado - GOOGLE_CLIENT_ID ou GOOGLE_CLIENT_SECRET não configurados no .env');
  }
