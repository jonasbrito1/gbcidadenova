...
import './Landing.css';
import './Landing-mobile-improvements.css';

const Landing = () => {
  // Hook do CMS - atualiza automaticamente a cada 10 segundos
  const { data: cmsData, loading: cmsLoading } = useCMSData(10000);
  ...
  // Helper para pegar dados do CMS com fallback
  const getCMSValue = (section, key, fallback = '') => {
    if (cmsLoading || !cmsData) return fallback;
    return cmsData[section]?.[key] || fallback;
  };
  ...
  const professors = [
    {
      id: "professor1",
      name: getCMSValue('professores', 'professor_1_nome', 'Professor Victor César'),
      belt: getCMSValue('professores', 'professor_1_faixa', 'Faixa Preta 2º Grau'),
      specialties: getCMSValue('professores', 'professor_1_especialidade', 'Especialista em ensino infantil, Bicampeão Brasileiro'),
      description: getCMSValue('professores', 'professor_1_especialidade', 'Faixa preta desde 2018, formado em Educação Física e especialista em ensino infantil. Bicampeão Brasileiro com experiência internacional nos EUA.'),
      image: getCMSValue('professores', 'professor_1_foto', '/images/victor.jpg'),
      fullBio: getCMSValue('professores', 'professor_1_bio', `Victor César é faixa preta de Jiu-Jitsu 2º grau desde 2018, com mais de uma década de experiência dedicada ao ensino da arte suave, especialmente com crianças. Formado em Educação Física desde 2016, alia conhecimento técnico e pedagógico para oferecer aulas seguras, divertidas e eficazes para todas as idades.
...
Como Professor especialista em ensino infantil da Gracie Barra Cidade Nova, o Professor Victor César acredita que o Jiu-Jitsu vai muito além das vitórias no tatame: é uma ferramenta poderosa de formação de caráter, disciplina e autoconfiança.`)
    ...
    {
      id: "professor2",
      name: getCMSValue('professores', 'professor_2_nome', 'Professor Ricardo Pires'),
      belt: getCMSValue('professores', 'professor_2_faixa', 'Faixa Preta 2º Grau'),
      specialties: getCMSValue('professores', 'professor_2_especialidade', 'Professor há 12 anos, formado pelo Sensei Henrique Machado'),
      description: getCMSValue('professores', 'professor_2_especialidade', '38 anos, iniciou aos 15 anos e é faixa preta desde 2016 pelo Sensei Henrique Machado. Professor há 12 anos, combina carreira no serviço público com dedicação total ao Jiu-Jitsu.'),
      image: getCMSValue('professores', 'professor_2_foto', '/images/professor_ricardo.png'),
      fullBio: getCMSValue('professores', 'professor_2_bio', `Professor Ricardo Pires, 38 anos, faixa preta 2° grau, é uma das referências técnicas da Gracie Barra Cidade Nova. Iniciou sua trajetória na arte suave aos 15 anos de idade e, desde então, vem construindo uma carreira marcada por dedicação, disciplina e paixão pelo tatame.
...
Apesar de ser um servidor de carreira no serviço público, Ricardo Pires mantém sua dedicação integral ao Jiu-Jitsu, conciliando suas funções profissionais com o constante estudo e o ensino da arte marcial.`)
  ...
  const galleryImages = [
    ...
    },
    {
      id: 3,
      src: "/images/gb5.png",
      title: "Modalidade Pequenos Campeões",
    ...
    {
      id: 5,
      src: "/images/gbcn_graduacao1.jpeg",
      title: "Cerimônia de Troca de Faixas",
      description: "Momento especial de reconhecimento e celebração da evolução dos nossos alunos"
    },
    {
      id: 6,
      src: "/images/gbcn_graduacao2.jpeg",
      title: "Graduação GB Cidade Nova",
      description: "Entrega de faixas e celebração das conquistas dos alunos da nossa equipe"
    },
    {
      id: 7,
      src: "/images/gb8.jpg",
      title: "Treino GB2 - Avançado",
      description: "Modalidade intermediária com técnicas mais complexas e sparring controlado"
    },
    {
      id: 8,
      src: "/images/gb1.jpg",
      title: "Filosofia Gracie Barra",
      description: "Transmissão dos valores de irmandade, respeito e integridade na nossa academia"
    },
    {
      id: 9,
      src: "/images/gb6.jpg",
  ...
  const schedules = [
    {
      time: "07:00",
      timeEnd: "08:00",
      monday: { class: "GB1", level: "iniciante", type: "adulto" },
      tuesday: { class: "GB1", level: "iniciante", type: "adulto" },
      wednesday: { class: "GB1", level: "iniciante", type: "adulto" },
      thursday: { class: "GB1", level: "iniciante", type: "adulto" },
      friday: { class: "GB1", level: "iniciante", type: "adulto" }
    },
    {
      time: "08:00",
      timeEnd: "09:00",
    ...
    },
    {
      time: "09:00",
      timeEnd: "10:00",
      monday: { class: "GB KIDS", level: "infantil", type: "kids" },
      tuesday: { class: "GB KIDS", level: "infantil", type: "kids" },
      wednesday: { class: "GB KIDS", level: "infantil", type: "kids" },
      thursday: { class: "GB KIDS", level: "infantil", type: "kids" },
      friday: { class: "GB KIDS", level: "infantil", type: "kids" },
      saturday: { class: "GB KIDS", level: "infantil", type: "kids" }
    },
    {
      time: "16:00",
      timeEnd: "17:00",
      saturday: { class: "GB2 NO GI Feminino", level: "avancado", type: "nogi" }
    },
    {
      time: "17:00",
      timeEnd: "18:00",
      ...
      wednesday: { class: "GB KIDS", level: "infantil", type: "kids" },
      thursday: { class: "GB KIDS", level: "infantil", type: "kids" },
      friday: { class: "GB Kids NO GI", level: "infantil", type: "nogi" },
      saturday: { class: "GB2 NO GI", level: "avancado", type: "nogi" }
    },
    {
      time: "18:00",
      timeEnd: "19:00",
      monday: { class: "GB K2", level: "juvenil", type: "kids" },
      tuesday: { class: "GB K2", level: "juvenil", type: "kids" },
      wednesday: { class: "GB K2", level: "juvenil", type: "kids" },
      thursday: { class: "GB K2", level: "juvenil", type: "kids" },
      friday: { class: "GB K2", level: "juvenil", type: "kids" }
    },
    {
      time: "19:00",
      timeEnd: "20:00",
    ...
    },
    {
      time: "20:00",
      timeEnd: "21:00",
      monday: { class: "GB2", level: "avancado", type: "adulto" },
      tuesday: { class: "GB2 NO GI", level: "avancado", type: "nogi" },
      wednesday: { class: "GB2", level: "avancado", type: "adulto" },
      thursday: { class: "GB2 NO GI", level: "avancado", type: "nogi" },
      friday: { class: "GB2", level: "avancado", type: "adulto" }
    }
  ];
  ...
  const getClassTypeColor = (level) => {
    switch(level) {
      case 'iniciante': return '#3b82f6'; // Azul para GB1
      case 'infantil': return '#fbbf24'; // Amarelo para GB KIDS
      case 'juvenil': return '#f97316'; // Laranja para GB K2
      case 'avancado': return '#a855f7'; // Roxo para GB2
  ...
  return (
    <div className="landing-page">
      {/* Header/Navigation */}
      <Navbar expand="lg" className="landing-nav">
        <Container>
          {/* Brand/Logo */}
          ...
          <Nav className="nav-menu d-none d-lg-flex mx-auto">
            ...
            <Nav.Link href="#modalidades" className="nav-link-custom">Modalidades</Nav.Link>
          ...
          <div className="header-actions d-none d-lg-flex">
            <Link to="/login" className="btn btn-login-header">
          ...
          >
            ...
            <Offcanvas.Body className="mobile-menu-body">
              ...
              <div className="mobile-menu-actions">
                <Link
                  to="/login"
                  className="btn btn-login-full-mobile"
                  onClick={() => setShowMobileMenu(false)}
                >
                  <FaUsers className="me-2" />
                  Área do Aluno
              ...
              <AnimatedSection animation="fadeInLeft" duration={0.8}>
                <h1 className="hero-title">
                  <span className="highlight">
                    {getCMSValue('hero', 'titulo_principal', 'Gracie Barra')}
                  </span>
                  <br />
                  {getCMSValue('hero', 'titulo_secundario', 'Cidade Nova')}
                </h1>
              </AnimatedSection>
              <AnimatedSection animation="fadeInLeft" delay={0.2} duration={0.8}>
                <p className="hero-description">
                  {getCMSValue('hero', 'subtitulo_principal', 'Jiu-Jitsu para todos os níveis e idades. Venha fazer parte da maior equipe de Jiu-Jitsu do mundo!')}
                </p>
              </AnimatedSection>
                ...
                <div className="academy-photo-wrapper">
                  <div
                    ...
                    onClick={() => {
                      openImageModal({
                        id: 'hero',
                        src: '/images/gbcn_time.jpeg',
                        title: 'Gracie Barra Cidade Nova',
                        description: 'Nossa equipe - Tradição e excelência no Jiu-Jitsu brasileiro'
                      });
                    }}
                  >
                    ...
                    <img
                      src="/images/gbcn_time.jpeg"
                      alt="Gracie Barra Cidade Nova - Equipe"
          ...
          <Row>
            <Col lg={12} className="text-center mb-5">
              <h2 className="section-title">
                <span className="title-word-black">Sobre a</span>{' '}
                <span className="title-word-red">Gracie Barra</span>{' '}
                <span className="title-word-blue">{getCMSValue('sobre', 'titulo_sobre', 'Cidade Nova')}</span>
              </h2>
              <p className="section-description">
                {getCMSValue('sobre', 'texto_sobre', 'A Gracie Barra Cidade Nova é uma academia dedicada ao ensino do Jiu-Jitsu brasileiro, seguindo a metodologia e filosofia da maior organização de Jiu-Jitsu do mundo.')}
              </p>
            </Col>
          </Row>
          ...
          <Row className="about-content-row">
            <Col lg={6} className="mb-4 mb-lg-0">
              <div className="about-text-container">
                ...
                <p className="about-description">
                  Com <strong>mais de 1000 escolas em 6 continentes</strong>, somos a maior organização de Jiu-Jitsu do mundo, promovendo transformação pessoal através da arte suave.
                </p>
      ...
      {/* Programs Section */}
      <section id="modalidades" className="programs-section">
        <Container>
          <Row>
            <Col lg={8} className="mx-auto text-center mb-5">
              <h2 className="section-title">
                <span className="title-word-black">Nossas</span>{' '}
                <span className="title-word-red">Modalidades</span>
              </h2>
              <p className="section-description">
                Oferecemos modalidades estruturadas para todas as idades e níveis de experiência.
              </p>
            </Col>
          </Row>
          <Row className="g-4">
              ...
              <Card className="program-card h-100">
                <Card.Body className="text-center">
                  ...
                  <p className="text-muted">
                    Modalidade para iniciantes com foco nos fundamentos básicos do Jiu-Jitsu e defesa pessoal. Ideal para quem está começando sua jornada no mundo das artes marciais.
                  </p>
                </Card.Body>
              </Card>
            </Col>
            ...
            <Col lg={4} md={6}>
              <Card className="program-card h-100">
                <Card.Body className="text-center">
                  ...
                  <h4>Modalidade Feminina</h4>
                  <p>Todas as idades</p>
                  <p className="text-muted">
                    Modalidade especial para mulheres, focando em defesa pessoal e empoderamento feminino em ambiente acolhedor.
                  </p>
                </Card.Body>
              </Card>
            </Col>
          ...
          <Row>
            <Col lg={8} className="mx-auto text-center mb-5">
              <AnimatedSection animation="fadeInUp" duration={0.8}>
                <h2 className="section-title">
                  <span className="title-word-black">Nossos</span>{' '}
                  <span className="title-word-red">Professores</span>
                </h2>
                <p className="section-description">
            ...
            <Col lg={12} className="mx-auto">
              <AnimatedSection animation="fadeInUp" duration={0.8}>
                <div className="text-center mb-5">
                  <h2 className="section-title">
                    <span className="title-word-blue">Horários</span>{' '}
                    <span className="title-word-black">de</span>{' '}
                    <span className="title-word-red">Treino</span>
                  </h2>
                  <p className="section-description">
              ...
              <AnimatedSection animation="scaleIn" delay={0.2} duration={0.6} className="stagger-children">
                <div className="schedule-legend">
                  <div className="legend-item" style={{'--stagger-index': 0}}>
                    ...
                    <span>GB1 - Adultos Iniciantes</span>
                  </div>
                  <div className="legend-item" style={{'--stagger-index': 1}}>
                    <span className="legend-color infantil"></span>
                    <span>GB KIDS - Infantil 3-7 anos</span>
                  </div>
                  <div className="legend-item" style={{'--stagger-index': 2}}>
                    <span className="legend-color juvenil"></span>
                    <span>GB K2 - Infanto-juvenil 8-13 anos</span>
                  </div>
                  <div className="legend-item" style={{'--stagger-index': 3}}>
                    <span className="legend-color avancado"></span>
                    <span>GB2 - Adultos Avançados (faixa branca III graus+)</span>
                  </div>
                </div>
              </AnimatedSection>
                            ...
                            <div className="mobile-class-content">
                              ...
                              <div className="mobile-class-info">
                                ...
                                <div className="mobile-class-level">
                                  {schedule[day.key].level === 'iniciante' && 'GB1 - Adultos Iniciantes'}
                                  {schedule[day.key].level === 'infantil' && 'GB KIDS - Infantil'}
                                  {schedule[day.key].level === 'juvenil' && 'GB K2 - Infanto-juvenil'}
                                  {schedule[day.key].level === 'avancado' && 'GB2 - Adultos Avançados'}
        ...
        <Container>
          <Row>
            <Col lg={8} className="mx-auto text-center mb-5">
              <AnimatedSection animation="fadeInUp" duration={0.8}>
                <h2 className="section-title">
                  <span className="title-word-blue">Entre</span>{' '}
                  <span className="title-word-black">em</span>{' '}
                  <span className="title-word-red">Contato</span>
                </h2>
                <p className="section-description">
              ...
              <AnimatedSection animation="slideInRight" delay={0.3} duration={0.6}>
                <Card className="contact-card h-100">
                  <Card.Body className="text-center">
                    ...
                    <h4>Horários</h4>
                    <p>
                      Segunda a Sexta: 07:00 - 10:00 e 17:00 - 21:00<br />
                      Sábado: 09:00 - 10:00 e 16:00 - 18:00<br />
                      Domingo: Fechado
                    </p>
                  </Card.Body>
                </Card>
          ...
          <Row>
            <Col lg={4} md={6}>
              <div className="footer-brand">
                ...
                <div className="social-links">
                  ...
                  <a
                    href="https://www.instagram.com/gb_cidadenova/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="social-link instagram-social"
                    title="Instagram"
                  >
                    <FaInstagram />
                  </a>
            ...
            <Col lg={4} md={12}>
              ...
              <div className="footer-hours">
                <p>Segunda a Sexta: 07:00 - 10:00 e 17:00 - 21:00</p>
                <p>Sábado: 09:00 - 10:00 e 16:00 - 18:00</p>
                <p>Domingo: Fechado</p>
              </div>
            </Col>
          </Row>
